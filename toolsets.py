...
_HERMES_CORE_TOOLS = [
    ...
    # Browser automation (Ghost stealth browser)
    ...
    "desktop_capture", "desktop_click", "desktop_double_click", "desktop_right_click",
    "desktop_type", "desktop_paste", "desktop_hotkey", "desktop_press",
...
TOOLSETS = {
    ...
    "ghost-desktop": {
        "description": (
            "Ghost cross-platform desktop control — human-like mouse (bezier curves), "
            "natural typing (realistic WPM + typos), screenshots with Vision analysis. "
            "Works on Windows, macOS (Apple Silicon + Intel), and Linux. "
            "Unlike computer_use (macOS-only cua-driver), this works everywhere."
        ),
        "tools": [
            "desktop_capture", "desktop_click", "desktop_double_click", "desktop_right_click",
            "desktop_type", "desktop_paste", "desktop_hotkey", "desktop_press",
